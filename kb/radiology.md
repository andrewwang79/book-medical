...
| DR(数字化放射成像) |  |  |
| NCCT(CT平扫/Noncontrast CT) |  |  |
| CTA(CT血管成像/CT Angiography) | 将动脉血管显影的药物注射到静脉内，利用CT机扫描获得的图像数据进行处理后，使头颈、心脏、肺动脉、主动脉等血管显影成像 |  |
| CTP(CT灌注成像/CT Perfusion) | [原理](https://blog.csdn.net/chenran187906/article/details/110387736) |  |
